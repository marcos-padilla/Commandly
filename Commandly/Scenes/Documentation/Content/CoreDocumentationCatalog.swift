enum CoreDocumentationCatalog {
    static let articles: [CoreDocumentationArticle] = [
        ...
        SettingsDocumentationArticle.article,
        PrivacyDocumentationArticle.article,
        AccessibilityDocumentationArticle.article,
    ]
}
